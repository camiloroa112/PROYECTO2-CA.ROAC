...
class test_funciones(unittest.TestCase):
    ...
    def test_es_sano(self): # Unittest #1
    ...
    def test_calorias(self): # Unittest #2
    ...
    def test_costos(self): # Unittest #3
        """Unittest to compare the value obtained from the .calorias() method with the predefined value in the test case"""
    ...
    def test_rentabilidad(self): # Unittest #4
    ...
    def test_producto_rentable(self): # Unittest #5
