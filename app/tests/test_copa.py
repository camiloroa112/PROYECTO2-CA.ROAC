...
class test_copa(unittest.TestCase):
    ...
    def test_calcular_costo(self): # Unittest #1
    ...
    def test_calcular_calorias(self): # Unittest #2
    ...
    def test_calcular_rentabilidad(self): # Unittest #3
        """Unittest to compare the profitability value obtained from the .calcular_calorias() with the value defined in the test case."""
    ...
    def test_get_nombre(self): # Unittest #4
    ...
    def test_get_precio_publico(self): # Unittest #5
    ...
    def test_get_tipo_vaso(self): # Unittest #6
    ...
    def test_set_nombre(self): # Unittest #7
    ...
    def test_set_precio_publico(self): # Unittest #8
    ...
    def test_set_tipo_vaso(self): # Unittest #6
        """Unittest to compare the new glass type from the Copa class with the value defined in the test case."""
