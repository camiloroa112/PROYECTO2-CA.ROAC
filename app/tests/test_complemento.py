...
class test_complemento(unittest.TestCase):
    ...
    def test_get_es_sano(self): # Unittest #2
    ...
    def test_set_es_sano(self): # Unittest #3
    ...
    def test_get_calorias(self): # Unittest #4
    ...
    def test_set_calorias(self): # Unittest #5
    ...
    def test_get_es_vegetariano(self): # Unittest #6
    ...
    def test_set_es_vegetariano(self): # Unittest #7
    ...
    def test_get_inventario(self): # Unittest #8
    ...
    def test_get_nombre(self): # Unittest #9
    ...
    def test_set_nombre(self): # Unittest #10
    ...
    def test_get_precio(self): # Unittest #11
    ...
    def test_set_precio(self): # Unittest #12
    ...
    def test_renovar_inventario(self): # Unittest #13
