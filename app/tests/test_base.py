...
class test_base(unittest.TestCase):
    ...
    def test_abastecer(self): # Unittest #1
    ...
    def test_get_sabor(self): # Unittest #2
    ...
    def test_set_sabor(self): # Unittest #3
    ...
    def test_get_es_sano(self): # Unittest #4
    ...
    def test_set_es_sano(self): # Unittest #5
    ...
    def test_get_calorias(self): # Unittest #6
    ...
    def test_set_calorias(self): # Unittest #7
    ...
    def test_get_es_vegetariano(self): # Unittest #8
    ...
    def test_set_es_vegetariano(self): # Unittest #9
    ...
    def test_get_inventario(self): # Unittest #10
    ...
    def test_get_nombre(self): # Unittest #11
    ...
    def test_set_nombre(self): # Unittest #12
    ...
    def test_get_precio(self): # Unittest #13
    ...
    def test_set_precio(self): # Unittest #14
